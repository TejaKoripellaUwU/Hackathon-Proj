...
def comparingTwoAndThreeDigitNumsProbs():
    problems=[]
    solutions=[]
    used=[]
    for i in range(1, 31):
...
def main():
    problems, solutions=addProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
    problems, solutions = subProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
    problems, solutions = moneyProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
    problems, solutions = standardFormProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
    problems, solutions = expandedFormProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
    problems, solutions = comparingTwoAndThreeDigitNumsProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
    problems, solutions = nextInSequenceProbs()
    for i in problems:
        print(i)
    for i in solutions:
        print(i)
